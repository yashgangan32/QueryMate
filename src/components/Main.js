    ...
    return (
        <div className='sm:flex-grow' >
            ...
            <div className='flex justify-between items-center'>
                <h1 className='ml-6 sm:m-5 text-4xl sm:text-3xl'

                >QueryMate</h1>
                <img src={logos.User} className='m-3 w-14 hover:scale-110'></img>
            </div>
            {/* main container*/}
            <div className='flex flex-col'>
                ...
                <div >
                    <p className='absolute bottom-3 left-1/2 transform -translate-x-1/2'>@2024 Yash gangan</p>
                </div>
